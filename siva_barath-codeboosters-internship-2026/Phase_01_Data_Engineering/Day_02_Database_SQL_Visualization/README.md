...
Write SQL to find the average programming score for female students only.
What is the difference between WHERE and HAVING? Give one example of each.
Write SQL to find departments where average attendance is above 85%.
What does `pd.read_sql_query()` return and what arguments does it need?
You want to show how math scores are distributed. Which chart type is best and why?
---
